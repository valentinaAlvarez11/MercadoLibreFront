    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative w-full">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 bottom-[-200px] w-[90vw] max-w-6xl flex justify-between gap-4 z-20">
          ...
          <div className="bg-white rounded-xl shadow-lg w-[158px] h-[285px] flex flex-col items-center p-4">
            <span className="font-bold text-sm text-gray-800 mb-3 text-center">Ingresa tu ubicación</span>
          ...
          <div className="bg-white rounded-xl shadow-lg w-[158px] h-[285px] flex flex-col items-center p-4">
            <span className="font-bold text-sm text-gray-800 mb-3 text-center">Ingresa a tu cuenta</span>
          ...
          <div className="bg-white rounded-xl shadow-lg w-[158px] h-[285px] flex flex-col items-center p-4">
            <span className="font-bold text-sm text-gray-800 mb-3 text-center">Medios de pago</span>
            <div className="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center mb-3 relative">
          ...
          <div className="bg-white rounded-xl shadow-lg w-[158px] h-[285px] flex flex-col items-center p-4">
            <span className="font-bold text-sm text-gray-800 mb-3 text-center">Menos de $40.000</span>
            <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mb-3 relative">
          ...
          {/* Card 6: Más vendidos */}
          <div className="bg-white rounded-xl shadow-lg w-[158px] h-[285px] flex flex-col items-center p-4">
            <span className="font-bold text-sm text-gray-800 mb-3 text-center">Más vendidos</span>
            <div className="w-16 h-16 bg-gray-200 rounded-lg flex items-center justify-center mb-3 relative">
